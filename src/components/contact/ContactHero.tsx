...
export const ContactHero = () => {
    return (
        <section className="relative min-h-[50vh] flex items-center justify-center overflow-hidden bg-white dark:bg-black pt-48 pb-20">
            ...
            {/* Ambient Background */}
            <div className="absolute top-0 right-1/4 w-[500px] h-[500px] bg-primary/20 rounded-full blur-[100px] -translate-y-1/2" />
            <div className="absolute bottom-0 left-1/4 w-[500px] h-[500px] bg-secondary/20 rounded-full blur-[100px] translate-y-1/2" />
            ...
            <div className="container mx-auto px-4 relative z-10 text-center">
                ...
                >
                    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/50 dark:bg-black/50 border border-slate-200 dark:border-white/10 backdrop-blur-sm mb-6 shadow-sm">
                        ...
                        <span className="text-sm font-bold text-slate-700 dark:text-slate-300 uppercase tracking-wider">Get in Touch</span>
                    </div>
