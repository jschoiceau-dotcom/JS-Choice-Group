...
export const BlogHero = () => {
    return (
        <section className="relative min-h-[85vh] flex items-center justify-center overflow-hidden">
            ...
            {/* Ambient Background */}
            <div className="absolute top-0 left-1/3 w-[500px] h-[500px] bg-primary/20 rounded-full blur-[120px] -translate-y-1/2 z-1" />
            <div className="absolute bottom-0 right-1/3 w-[400px] h-[400px] bg-secondary/20 rounded-full blur-[100px] translate-y-1/2 z-1" />
            ...
            <div className="container mx-auto px-4 relative z-10 text-center">
                ...
                >
                    <div className="inline-flex items-center gap-2 px-5 py-2 rounded-full bg-white/10 border border-white/20 backdrop-blur-md mb-8 shadow-2xl">
                        ...
                        <span className="text-sm font-bold text-white uppercase tracking-widest">Our Blog</span>
                    </div>
                    ...
                    <h1 className="text-5xl md:text-7xl lg:text-8xl font-black text-white mb-8 tracking-tight leading-[1.05]">
                        ...
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary via-white to-secondary">Stories.</span>
                    </h1>
